...
### Cloning the project
 ...
 git clone https://github.com/sentayhu19/hello-rails-back-end <Your-Build-Directory>
``` 
...
Feel free to check the [issues page](https://github.com/sentayhu19/hello-rails-back-end/issues).
